...
Finally, the `getDrugData` function retrieves drug response data:
```{r}
...
This should take no more than 1-2 seconds for each constituent retrieval, and ~5 seconds to make the data frame depending on your hardware.
